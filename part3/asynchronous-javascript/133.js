          ...
          changeText(heading6, 'six', 'red', 1000, () => { 
            changeText(heading7, 'seven', 'violet', 1000, () => { 
              changeText(heading8, 'eight', 'grey', 1000, () => { 
                changeText(heading9, 'nine', 'purple', 1000, () => { 
                  changeText(heading10, 'ten', 'blue', 1000, () => { 

                  },()=>{console.log('heading8 is does not exist')})
                },()=>{console.log('heading8 is does not exist')})
              },()=>{console.log('heading8 is does not exist')})
            },()=>{console.log('heading7 is does not exist')})
          },()=>{console.log('heading6 is does not exist')})
        },()=>{console.log('heading5 is does not exist')})
      },()=>{console.log('heading4 is does not exist')})  
    },()=>{console.log('heading3 is does not exist')})
  },()=>{console.log('heading2 is does not exist')})
},()=>{console.log('heading1 is does not exist')})
